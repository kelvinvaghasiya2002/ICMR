    ...
    <section>
      ...
      <div className="siteInfo" data-aos="fade-left">
        ...
        <div className="formcontent">
          ...
          <InputField value={form2A.H2A1} onChange={handleChange(setForm2A)} h3="2A.1 : Assessor’s Name: " placeholder="Type here" name="H2A1" />
          ...
          <InputField value={form2A.H2A5} onChange={handleChange(setForm2A)} h3="2A.5 : Healthcare Facility Address :" placeholder="Type here" name="H2A5" />

          <InputField value={form2A.H2A6} onChange={handleChange(setForm2A)} h3="2A.6 : Name of the MOIC :" placeholder="Type here" name="H2A6" />

          <InputField value={form2A.H2A7} onChange={handleChange(setForm2A)} h3="2A.7 : Contact Number of MOIC :" placeholder="Type here" name="H2A7" />
          ...
          <Buttons formName="form2a" formData={form2A} prevText="" nextText="Save & Next" prev="" next="/infrastructure-2" />
        </div>
      </div>
    </section>
    </div>
