        ...
        <div className="siteInfo" data-aos="fade-left" >
          ...
          <div className="formcontent">
...

            {
              (form2G.H2G3 === "Yes") &&
              <>
                <Radio byDefault={form2G.H2G4} onClick={handleChange(setForm2G)} h3="2G.4 : If funds are available, which health protection schemes are covering your emergency care system?" CheckbobItems={["PMJAY", "RKS", "Other (Specify)"]} otherArray={[0, 0, 1]} name="H2G4" />
