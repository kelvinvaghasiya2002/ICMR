...
function FormAC7() {
    ...
    return (
        <section id='stroke'>
            ...
            <button className='nextbtn'><Link style={{ color: "white" }} to="/formsac-acuterespiratoryillness">Next</Link></button>
        </section>
    )
}
