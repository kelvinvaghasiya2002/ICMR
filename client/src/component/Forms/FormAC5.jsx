...
function FormAC5() {
    ...
    return (
        <section id='trauma-burns'>
            ...
            <div>
                <h3>In the past 1 year, did you or any member of this household suffered from sudden injury in Road Traffic Accident/ severe fall/ drowning/ stabbing/ gunshot/ any other assault/ suicidal attempt/ burns/ domestic violence/ homicidal etc. that required immediate medical service?</h3>
