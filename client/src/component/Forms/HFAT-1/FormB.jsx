    ...
    <section>
      ...
      <div className="siteInfo">
        ...
        <div className="formcontent">
          ...
          <InputField name="B1" h3="How many beds are available for the in-patient department (IPD)?" type="number" value={formB.B1}  onChange={handleChange(setFormB)} placeholder="Type here" />
          ...
          <InputField name="B3" type="number" onChange={handleChange(setFormB)} h3="How many beds are available for emergency care?" value={formB.B3} placeholder="Type here" />

          <Radio h3="Number of Beds by Emergency Severity Index (ESI):" CheckbobItems={[" Red", " Yellow", "Green"]} name="B4" onClick={handleChange(setFormB)} byDefault={formB.B4} />

          <InputField name="B5" onChange={handleChange(setFormB)} h3="What is the average number of patients presenting to OPD per month?" value={formB.B5} placeholder="Type here" type="number" />
          ...
          <Radio h3="Does the facility have a licensed in-house blood bank?" onClick={handleChange(setFormB)} CheckbobItems={["Yes, it is available 24/7", "Yes, but it is not available 24/7","No, but there is a tie up with external Blood bank facility", "No"]} name="B7" byDefault={formB.B7} other={true} />
