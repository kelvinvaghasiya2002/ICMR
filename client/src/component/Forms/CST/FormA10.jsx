...
function FormA10() {
    ...
    const { isValid, errors, setErrors } = useFormValidation(formA3, [
        "AC10_1",
        ...(formA3.AC10_1 === "Yes" ? ["AC10_1_if", "AC10_2"] : [])
    ]);
                ...
                <div className='siteInfo'>
                    ...
                    <div className="formcontent cont_extra">
...

                        {
                            (formA3.AC10_1 === "Yes") &&
                            <>
                                <InputField onChange={handleChangeWithValidation} h3="If Yes, What were the symptoms of emergency conditions and first course of action?" placeholder="Type here" name="AC10_1_if" value={formA3.AC10_1_if} />
                                ...
                                <Radio onClick={handleChange(setFormA3)} CheckbobItems={fetchCstTableDetail()} name={"AC10_2"} h3="AC.10.2  If yes, could you please tell who all from your Household suffered with this condition?" byDefault={formA3.AC10_2} />
                            </>
                        }
