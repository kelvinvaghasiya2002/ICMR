...
function FormA2() {
    ...
    const { isValid, errors, setErrors } = useFormValidation(formA2, [
        "AB1",
        "AB2",
        "AB3",
        "AB4",
    ...
    const handleChangeWithValidation = (e) => {
        ...
        setFormA2((prevValue) => ({ ...prevValue, [name]: validatedValue }));
            ...
            <section id='site-info' className="form-main">
                ...
                <div className='siteInfo'>
                    ...
                    <div className="formcontent cont_extra">
                        ...
                        <InputField h3="AB.3  Name of PSU (Town/Village) :" placeholder="Type here" name="AB3" onChange={handleChangeWithValidation} value={formA2.AB3} />
