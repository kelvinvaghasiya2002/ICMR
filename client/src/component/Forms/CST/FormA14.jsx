      ...
      <section id='site-info'>
          ...
          <div className='siteInfo'>
              ...
              <div className="formcontent cont_extra">
                  ...
                  <Radio onClick={handleChange(setFormA3)} h3="AC.14.1  Apart from the above-mentioned conditions, did anyone suffer from any other conditions that required immediate emergency services? " CheckbobItems={["Yes", "No"]} name="AC14_1" otherArray={[1,0]} byDefault={formA3.AC14_1}/>
