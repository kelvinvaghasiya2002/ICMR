    ...
    <section id='household-schedule'>
      ...
      <div className='siteInfo'>
        ...
        <div className='formcontent'>
          ...
          <InputField h3="Name of the Head of the Household : " placeholder="Type here" />

          <InputField h3="Age (in Years) :" placeholder="Type here" />

          <Checkbox h3="Sex :" CheckbobItems={["Male", "Female", "Other"]} name="sex" />

          <Checkbox h3="Religion :" CheckbobItems={["Hindu", "Muslim", "Sikh", "Christian", "Buddhist/ Neo-Buddhist", "Jain", "Jewish", "Parsi/ Zoroastrian", "No Religion", "Other", "Prefer not to disclose/ Refuse"]} name="religion" />

          <Checkbox h3="Caste :" CheckbobItems={["General/ Unreserved (UR)", "Scheduled Caste (SC)", "Schedules Tribe (ST)", "Other Backward Class (OBC)", "None of the above", "Don’t Know", "Prefer not to disclose/ Refuse"]} name="cast" />

          <Checkbox h3="Marital status: (Select the appropriate response):" CheckbobItems={["Never married", "Currently Married", "Separated  ", "Divorced  ", "Widow", "Cohabitating", "Prefer not to disclose/ Refuse"]} name="marital_status" />
