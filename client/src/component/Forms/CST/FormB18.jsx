    ...
    <section>
      ...
      <div className="siteInfo">
        ...
        <div className="formcontent">
          ...
          <Buttons formName={"formb18"} formData={formB18}  prevText="Previous" nextText="Save & Next"  prev="/formsb-sociodemographicprofile" next="/formsb-initialhealthcareseekingpathway2" />
        </div>
      </div>
    </section>
  )
