          ...
          <div className="formcontent cont_extra">
...

            {
              ...
              <>
                ...
                <Radio onClick={handleChange(setFormA3)} CheckbobItems={fetchCstTableDetail()} name="AC9_2" h3="AC.9.2  If yes, could you please tell who all from your Household suffered with this condition?"  byDefault={formA3.AC9_2} />
              </>
            }
