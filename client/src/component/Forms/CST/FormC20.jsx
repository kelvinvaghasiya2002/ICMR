    ...
    <section>
      ...
      <div className="siteInfo">
        ...
        <div className="formcontent">
          ...
          <Buttons formName={"formc20"} formData={formC20}  prevText="Previous" nextText="Save & Next"  prev="/formsb-initialhealthcareseekingpathway2" next="//formsd-barriersandfacilitatorsinseekingcare" />
        </div>
