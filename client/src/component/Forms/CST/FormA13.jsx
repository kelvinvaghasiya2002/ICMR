...
function FormA13() {
    ...
    const { isValid, errors, setErrors } = useFormValidation(formA3, [
        "AC13_1",
        ...(formA3.AC13_1 === "Yes" ? ["AC13_1_if", "AC13_2"] : [])
    ]);
                ...
                <div className='siteInfo'>
                    ...
                    <div className="formcontent cont_extra">
...

                        {
                            (formA3.AC13_1 === "Yes") &&
                            <>
                                <InputField onChange={handleChangeWithValidation} h3="If Yes, What were the symptoms of emergency conditions and first course of action?" placeholder="Type here" name="AC13_1_if" value={formA3.AC13_1_if} />
                                ...
                                <Radio onClick={handleChange(setFormA3)} CheckbobItems={fetchCstTableDetail()} name={"AC13_2"} h3="AC.13.2  If Yes, Could you please tell who all suffered with this condition?" byDefault={formA3.AC13_2} />
                            </>
                        }
