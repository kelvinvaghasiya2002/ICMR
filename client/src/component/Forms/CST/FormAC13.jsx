    ...
    return (
        <section id='Others'>
            ...
            <div className="siteInfo">
                ...
                <Buttons formName={"formac13"} formData={formAC13}  prevText="Previous" nextText="Save & Next"  prev="/formsac-poisoning" next="/formsac-verbal&socialautopsyquestionnaire" />
                </div>
            </div>
        </section>
    )
