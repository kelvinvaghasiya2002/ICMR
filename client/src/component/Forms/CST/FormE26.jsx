...
function FormE26() {
    ...
    const { isValid, errors, setErrors } = useFormValidation(formE26, [
        "E1",
        "E2",
        "E3_a",
        "E3_b",
    ...
    const handleChangeWithValidation = (e) => {
        ...
        setFormE26((prevValue) => ({ ...prevValue, [name]: validatedValue }));
            ...
            <section id='site-info' className="form-main">
                ...
                <div className='siteInfo'>
                    ...
                    <div className="formcontent ">
                        ...
                        <InputField h3="E.4	What was the approximate overall money spent on the availing the emergency care service? Direct Medical Cost" placeholder="Type here" name="E4" value={formE26.E4} onChange={handleChangeWithValidation} />
                        ...
                        <InputField h3="E.6	What was the approximate overall money spent on the availing the emergency care service? Direct Non-Medical Cost" placeholder="Insert Number " name="E6" value={formE26.E6} onChange={handleChangeWithValidation} />
                        ...
                        Cost of lost productivity due to missed workdays= Patients missed workdays + patient’s family’s missed work days)*Average daily wage rate" placeholder="Type here" name="E7" value={formE26.E7} onChange={handleChangeWithValidation} />
                        ...
                        Cost of lost productivity due to premature death= {Retirement age (60)- age of premature death}*Average annual income}" placeholder="Type here" name="E8" value={formE26.E8} onChange={handleChangeWithValidation} />

                        <h3>
                            E.9 : What were the sources through which you met the expenses for emergency care and what is the amount covered?
                        </h3>

                        <InputField h3="a. Personal Income" placeholder="Amount in Rs." name="E9_a" value={formE26.E9_a} onChange={handleChangeWithValidation} />

                        <InputField h3="b. Household income excluding personal income" placeholder="Amount in Rs." name="E9_b" value={formE26.E9_b} onChange={handleChangeWithValidation} />

                        <InputField h3="c. Savings" placeholder="Amount in Rs." name="E9_c" value={formE26.E9_c} onChange={handleChangeWithValidation} />

                        <InputField h3="d. Loan from Bank" placeholder="Amount in Rs." name="E9_d" value={formE26.E9_d} onChange={handleChangeWithValidation} />

                        <InputField h3="e. Borrowed from friends/relatives" placeholder="Amount in Rs." name="E9_e" value={formE26.E9_e} onChange={handleChangeWithValidation} />

                        <InputField h3="f. Contribution from friends/relatives" placeholder="Amount in Rs." name="E9_f" value={formE26.E9_f} onChange={handleChangeWithValidation} />

                        <InputField h3="g. Selling assets/property/jewellery" placeholder="Amount in Rs." name="E9_g" value={formE26.E9_g} onChange={handleChangeWithValidation} />

                        <InputField h3="h. Insurance coverage" placeholder="Amount in Rs." name="E9_h" value={formE26.E9_h} onChange={handleChangeWithValidation} />

                        <InputField h3="i. Reimbursement from employer" placeholder="Amount in Rs." name="E9_i" value={formE26.E9_i} onChange={handleChangeWithValidation} />

                        <InputField h3="j. Other (Specify)" placeholder="Amount in Rs." name="E9_j" value={formE26.E9_j} onChange={handleChangeWithValidation} />

                        <InputField h3="E.10 Based on your experience what suggestion would you like to make to the government to improve the emergency services in your district? " placeholder="Type here" name="E10" value={formE26.E10} onChange={handleChangeWithValidation} />
