...
function Form3F() {
  ...
  return (
    ...
    <div className="siteInfo">
      ...
      <Radio byDefault={form3F.H3F8} onClick={handleChange(setForm3F)} name="H3F8" h3="Do you get Pre-Hospital Notification during an emergency?" CheckbobItems={["Yes ___________ (How often per week)", "No"]}  />
