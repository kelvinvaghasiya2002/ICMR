...
<Checkbox setFunction={setForm3H} StateValue={form3H} array={form3H.H3H8} name="H3H8" h3="Types of audits conducted?" CheckbobItems={["Mortality audit","Morbidity Audit","Others (Specify)_______________"]} />
