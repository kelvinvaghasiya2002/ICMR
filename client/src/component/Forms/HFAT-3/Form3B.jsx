...
function Form3B() {
  ...
  return (
    ...
    <div className="siteInfo">
      ...
      <InputField value={form3B.H3A5} onChange={handleChange(setForm3B)} name="H3B5" h3="3B.5 : What is the average number of patients presenting to OPD in a day/ everyday?" placeholder="Type here"/>
