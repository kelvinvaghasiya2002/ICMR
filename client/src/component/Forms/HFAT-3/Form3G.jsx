...
function Form3G() {
  ...
  return (
    ...
    <div className="siteInfo">
      ...
      <Radio byDefault={form3G.H3G4} onClick={handleChange(setForm3G)} name="H3G4" h3="If funds are available, which health protection schemes are covering your emergency care system?" CheckbobItems={["PMJAY", "RKS","Others(Specify) _____________________"]}  />
