    ...
    return (
        <div ref={menuRef} className='container' style={{ display: menuState ? "block" : "none" }} >
            ...
            <div style={{ padding: "2%"}}>
                ...
                <Link to="/healthfacilityinformation"><h3 onClick={()=>{setMenuState(false)}}>HFAT:  District Hospital/Tertiary Care (Public or Private)</h3></Link>
                <Link to="/facilityinformation-2"><h3 onClick={()=>{setMenuState(false)}}>HFAT:  CHC</h3></Link>
                <Link to="/facilityinformation-3"><h3 onClick={()=>{setMenuState(false)}}>HFAT:  PHC</h3></Link>
